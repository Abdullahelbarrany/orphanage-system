...
<body>
   <div class="main">
    <p class="sign" align="center">Donation Details</p>
    <form action="../controller/dondetails.php" method="post">
   <div class="form-group ">
         <div class="un">
           <input class="un " name="name" type="text" align="center" placeholder="Qty">
              </div>
    ...
    include_once "../controller/usertcontroller.php";
     ?>
        ...
        <a href="currency.php" class="Submit">Convert Currency</a>        
